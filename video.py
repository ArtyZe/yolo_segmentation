...
def detect(net, meta, image, thresh=.5, hier_thresh=.5, nms=.45):
    ...
    print(pred)
    show_image(pred, "test".encode("utf-8"), 0)
    return pred
...
if __name__ == "__main__":
    net = load_net("cfg/instance_segment_folder.cfg".encode("utf-8"), "backup/instance_segment_folder_40000.weights".encode("utf-8"), 0)
    meta = load_meta("cfg/maskyolo.data".encode("utf-8"))
    ...
    while(1):
        ...
        lib.copy_image_from_bytes(darknet_image, frame_resized.tobytes())
        r = detect_frame(net, meta, darknet_image)
